...
|  12  | 03/31/22     | Learner language [1] <br>                                                                                                      PsychoPy [2] <br>                                                                                                              [{{% staticref "376SLA/SL/LG376-12.pdf" "newtab" %}}Class 12{{% /staticref %}}, {{% staticref                                  "376SLA/SL/LG376-L3.pdf" "newtab" %}}Lab 3{{% /staticref %}}, {{% staticref "376SLA/WSH/Exp_stim.zip"                          "newtab" %}}Exp_stimuli.zip{{% /staticref %}}]                                                                                                                      | USLA (Sec. 6.1, 6.2, 6.3, 6.4, 6.5)                                                                                                              | Turn in **Reference list**           |
