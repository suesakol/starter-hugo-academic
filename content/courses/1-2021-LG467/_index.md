...
|  13  | 11/03/21  | Syntactic parsing <br>                                                                                                        [{{% staticref "467LC_2021/Slides/LG467-11.pdf" %}}Parsing (1){{% /staticref %}}] <br>                                        [Python code: {{% staticref "467LC_2021/Scripts/CL11.py" %}}CL11.py{{% /staticref %}}]                                                                            | [J & M Ch. 12](https://web.stanford.edu/~jurafsky/slp3/12.pdf) <br>                                                             (Secs. 12.1, 12.2, 12.4)                                                                                                              |                                         |
