...
|  15  | 11/17/21  | Syntactic parsing <br>                                                                                                        [{{% staticref "467LC_2021/Slides/LG467-12.pdf" %}}Parsing (2){{% /staticref %}}] <br>                                        [Python code: {{% staticref "467LC_2021/Scripts/CL12.py" %}}CL12.py{{% /staticref %}}]                                                                             | [J & M Ch. 14](https://web.stanford.edu/~jurafsky/slp3/14.pdf)<br>                                                             (Secs. 14.1-14.3)                                                                                                                           |                                   |
